...
basic_date = datetime(now.year, now.month+2%12, 28)
...
# Start to Change Prices
                    if int((pdate - today).days) <= int(3):
                       bnbprice = int(int(int(int(basic_contract_price*0.6)*1.1/1.05/10)*10)+10+today_lastnum)
                    elif int((pdate - today).days) <= int(7):
                       bnbprice = int(int(int(int(basic_contract_price*0.8)*1.1/1.05/10)*10)+10+today_lastnum)
                    else:
                       bnbprice = int(int(int(int(bnbprice)/1.05/10)*10)+10+today_lastnum)
# Changed.
...
# Jacob Waka Login Info
              ...
              ### Start
                ...
                # change new_price to pri
                       payload = {"new_price":pri,"dates":dates,"room_uuid":wakarooms[ie]}
